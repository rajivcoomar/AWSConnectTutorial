...
Booking
	...
	Ask from, to : city, date, no of passenger - 
	Ask for confirmation through button

	List view : flight details
	Saver, Flexi plus, Super 6E
	Book button

	Ask Mobile number, email
	Display price, 
	Payment - Transfer to an agent
--------------------------------------
Manage:
	Ask Email, PNR , 
	Display flight details : edit or cancel
	Edit- ask for new date
	Cancel - mobile number - will just cancel display + send email
---------------------------------------
Info - Flight status
---------------------------------------
...
Github code to run locally:  https://github.com/rajivcoomar/DialogflowES/blob/main/Node.js_Code/LoadHTML.js
...
Part 8 API Integration: https://youtu.be/ZYf24i2R6-o
